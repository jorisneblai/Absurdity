...
function About() {
    return (
        <main className="About-main">
            <Segment textAlign='left' className="About-bio">
                ...
                <p>
                    Vous pouvez voter pour votre réponse préférée y compris la vôtre, mais pensez à vos chevilles...</p>
                <p>
            ...
            <Container className="Trombi">
                ...
                <AboutProfil image={nabiha} name='Nabiha' role='Référente technologies' description='Il ne faut pas dire: FrontEnd je ne boirai pas de ton Node.' />
                ...
                <AboutProfil idromain="shakeshakeshake" image={romain} name='Romain' role='Scrum Master et Git Master' description="C'est en commençant par tout détruire que nous pouvons reconstruire. [DIEU]" />
